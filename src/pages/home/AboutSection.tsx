...
export default function AboutSection() {
  return (
    <div className="md:px-[8%] px-3 py-[4rem] md:flex items-center">
      <div className="md:w-[45%] md:mr-12 md:mb-0 mb-5">
        <img className="md:h-[500px] h-[250px] w-full rounded-md" src={process.env.PUBLIC_URL+'./images/A-street-child-crying-consoled-by-his-friend-in-Ouagadougou-Burkina-Faso.webp'} alt="" />
      </div>
