...
export default function Header() {
  ...
  const headerText = (cName:string) => (
    ...
    >
      ...
      {/* <h1 className="title md:text-7xl text-2xl md:font-bold">Give us opportunity</h1> */}
      {/* <h1 className="md:text-6xl text-2xl ont-bold md:my-2">to study and change our story</h1> */}
