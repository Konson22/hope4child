  ...
  const headerText = (
    <div className="">
      ...
      <div className="flex items-center md:mt-6">
        <Link className="md:px-6 px-3 md:py-4 py-2 rounded text-white bg-yellow-500 mr-3" to='/sponsor-child'>Sponsor a child</Link>
        <Link className="md:px-5 px-3 md:py-4 py-2 rounded text-white bg-yellow-500" to='/register-child'>
