...
import { HeadingText1, HeadingText3 } from "components/HeadingText";
import Slider from "rc-slider";

export default function ProjectSection() {
  return (
    <div className="md:px-[8%] px-4 md:py-[5rem] py-[2rem] bg-rose-5000">
        <HeadingText1 text="OUR ONGING PROJECTS" cName="text-center mb-6" />
